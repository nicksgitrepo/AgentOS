...
const review = {candidate_ref: "ref:CANDIDATE/INDEPENDENT_AUDITOR/1", candidate_digest: digest, candidate_commit_sha1: "a".repeat(39)+"1", candidate_tree_sha1: "b".repeat(39)+"2", rollback_commit_sha1: "c".repeat(39)+"3", rollback_tree_sha1: "d".repeat(39)+"4", candidate_status: "CURRENT_CANDIDATE", package_scope: "ONE_EXACT_CANDIDATE", author_identity: "AGENT.BUILDER", evaluator_identity: "AGENTOS.INDEPENDENT_EVALUATOR", auditor_task_id: "TASK.AUDITOR.INDEPENDENT.PACKAGE", auditor_task_status: "ADMITTED_CURRENT", auditor_round_ref: "opaque:round:INDEPENDENT.AUDITOR.1", auditor_round_sha256: digest, builder_worktree_ref: "opaque:worktree:BUILDER.1", auditor_worktree_ref: "opaque:worktree:AUDITOR.1", read_only_verified: true, candidate_mutation_allowed: false, merge_allowed: false, deploy_allowed: false, execution_status: "READY_FOR_EVALUATION", evaluator_status: "ADMITTED_CURRENT", independence_status: "SEPARATE_CONTROLLED_IDENTITIES", gate_status: "COMPLETE_EXECUTABLE", fixture_status: "COMPLETE_EXECUTABLE", source_status: "CURRENT_VERIFIED", custody_status: "BOUND", model_policy_status: "CURRENT_BOUND", requested_action: "INSPECT", requested_tools: ["READ_CANDIDATE", "READ_GATES", "READ_FIXTURES", "READ_SOURCE_LOCK", "READ_MODEL_POLICY", "READ_CUSTODY"], required_blocks: ["SPECIALIST.FOUNDATION.EVALUATION_ADMISSION_GATE", "SPECIALIST.FOUNDATION.EVIDENCE_FRESHNESS_GATE"], earlier_packages_status: "NONE", recheck_scope: "NONE", new_findings: false, project_data_present: false, secret_data_present: false, adversarial_flags: flags};
