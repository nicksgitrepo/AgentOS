...
import {evaluateOwaspApi6Package} from "../control/owasp-api-2023-api6-sensitive-business-flows-package-evaluator.mjs";
import {compileReusableAgentRoster} from "../control/reusable-agent-roster-compiler.mjs";

const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..");
const result = await evaluateOwaspApi6Package();
...
const readbackPath = path.join(root, "specialist-blocks/registry/owasp-api-2023-api6-sensitive-business-flows-operational-readback.v1.json");
...
const api6 = roster.entries.find((entry) => entry.stable_agent_id === "AGENT.SECURITY_OWASP_API_2023_API6_SENSITIVE_BUSINESS_FLOWS");
assert(api6, "API6 roster entry missing");
...
const persisted = [
  "control/owasp-api-2023-api6-sensitive-business-flows-authority-binding.mjs",
  "control/owasp-api-2023-api6-sensitive-business-flows-boundary-gate.mjs",
  "control/owasp-api-2023-api6-sensitive-business-flows-package-evaluator.mjs",
  "control/owasp-api-2023-api6-sensitive-business-flows-rebind.mjs",
  "control/reusable-agent-roster-compiler.mjs",
  "schemas/owasp-api6-operational-readback.v1.json",
  "specialist-blocks/registry/agent-roster.v1.json",
  "specialist-blocks/registry/owasp-api-2023-api6-sensitive-business-flows-operational-readback.v1.json",
  "specialist-blocks/wave-03/owasp-api-2023-api6-sensitive-business-flows/context.json",
  "specialist-blocks/wave-03/owasp-api-2023-api6-sensitive-business-flows/gates/execution.json",
  "specialist-blocks/wave-03/owasp-api-2023-api6-sensitive-business-flows/model-route.json",
];
...
console.log("PASS OWASP API6 boundary: executable readback, hostile regressions, roster queue advancement, and runtime portability");
