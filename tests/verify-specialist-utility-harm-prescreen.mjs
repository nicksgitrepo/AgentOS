...
assert.equal(actual.packages_checked, 125);
assert.equal(actual.cases_checked, 2125);
...
assert.equal(actual.candidate.commit, "f09c975317137cbe5b85ae9cccb1a05c47688a57");
assert.equal(actual.candidate.tree, "9fb6003a3e0c3644fc0398b6aa61b0066014ff7d");
