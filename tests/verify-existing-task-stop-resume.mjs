...
assert.throws(() => authorizeSingleReplacement(exhausted(), {replacementTaskId: "TASK.REPLACEMENT.001", roleLockNonce: "NONCE.HOST.LIFECYCLE.001", binding, oldTaskRetired: false, oldTaskProcesses: [], pinnedThreads: ["TASK.EXISTING.001"]}), /retirement (attestation|evidence)|retired and inert/u);
