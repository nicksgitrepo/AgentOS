...
function makeRound(overrides = {}) {
  ...
  const round = {
    ...
    candidate, model_policy: {snapshot_sha256: digest("model-snapshot"), projection_sha256: digest("model-projection"), model_id: "MODEL.CAPABLE.1", reasoning_effort: "MAX", availability: "CURRENT_HOST_AVAILABLE", status: "CURRENT_BOUND"},
