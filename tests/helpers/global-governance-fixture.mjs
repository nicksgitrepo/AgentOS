...
export function compileTestGlobalGovernance({nowUtc = "2026-08-21T04:09:00.000Z"} = {}) {
...
export function materializeTestGlobalGovernanceStore({authorityRoot, nowUtc = "2026-08-21T04:09:00.000Z"} = {}) {
