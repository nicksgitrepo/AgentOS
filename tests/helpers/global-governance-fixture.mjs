...
export function compileTestGlobalGovernance({nowUtc = new Date().toISOString()} = {}) {
...
export function materializeTestGlobalGovernanceStore({authorityRoot, nowUtc = new Date().toISOString()} = {}) {
