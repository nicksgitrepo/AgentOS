...
const emittedInventory = [
  ...
  "START_PLATFORM_REVIEW", "START_CENTRAL_INTEGRATION", "START_INDEPENDENT_REAUDIT", "PREPARE_CANDIDATE_REVIEW", "RETRY_SPAWNER_QA", "WAIT_FOR_PROTECTED_EVENT", "NONE",
  "ASSEMBLE_ISOLATED_CUMULATIVE_CANDIDATE",
  "START_NEXT_AVAILABLE_CONTROLLER_TRANSITION", "START_NEXT_LOCAL_BLOCK_REPAIR", "WAIT_FOR_PROTECTED_WAVE_ACTIVATION", "PREPARE_DEVELOPMENT_CANDIDATE_REVIEW", "START_IMPORT_ORCHESTRATOR", "RUNTIME_ATOMIC_GIT_REPOINT", "RUN_LOCAL_CANDIDATE_PROOF",
].sort();
