...
const emittedInventory = [
  ...
  "START_NEXT_AVAILABLE_CONTROLLER_TRANSITION", "START_NEXT_LOCAL_BLOCK_REPAIR", "WAIT_FOR_PROTECTED_WAVE_ACTIVATION", "PREPARE_DEVELOPMENT_CANDIDATE_REVIEW", "START_IMPORT_ORCHESTRATOR", "RUNTIME_ATOMIC_GIT_REPOINT",
].sort();
