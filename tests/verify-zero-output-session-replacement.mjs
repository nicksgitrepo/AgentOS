...
const input = {
  ...
  turn: {status: "COMPLETED", error: null, elapsed_seconds: 68, assistant_items: 0, tool_items: 0, command_items: 0, durable_result_items: 0, live_process_count: 0, turn_readback_sha256: digest("turn")},
  ...
  replacement: {session_id: "SESSION.NEW", project_bound: true, cwd_verified: true, visible_assistant_items: 1, visible_tool_items: 1, probe_readback_sha256: digest("probe"), same_worktree: true, custody_mutated: false},
};
