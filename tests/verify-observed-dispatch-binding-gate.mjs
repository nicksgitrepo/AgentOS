...
const authorityRebindReceipt = compileAuthorityRebindReceipt({
  ...
  authority: {repository: "AgentOS", branch: "repair/observed-dispatch", remote_ref: "refs/heads/repair/observed-dispatch", commit: "a".repeat(40), tree: "b".repeat(40), parent: "c".repeat(40), remote_verified: true, worktree_clean: true},
