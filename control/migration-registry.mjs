...
const SEAMS = Object.freeze([
  ...
  {seam_id: "NATIVE_SESSION_LIFECYCLE", replacement_paths: ["control/native-session.mjs", "control/native-host-attachment.mjs", "control/native-host-loader.mjs", "schemas/native-host-attachment.v1.json"], evidence_test: "tests/verify-native-host-attachment.mjs", status: "EXTERNAL_HOST_REQUIRED"},
