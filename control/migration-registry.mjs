...
const SEAMS = Object.freeze([
  ...
  {seam_id: "TWELVE_LANE_EXECUTION", replacement_paths: ["control/campaign-orchestrator.mjs", "control/campaign-runner.mjs"], evidence_test: "tests/verify-campaign-orchestrator.mjs", status: "PARTIAL"},
