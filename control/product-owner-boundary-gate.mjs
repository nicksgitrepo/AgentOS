...
const ROUTE = Object.freeze({
  ...
  DECLARED_INTENT_IMPLEMENTATION: ["ROUTE_HANDOFF", "CONTROLLER", "DECLARED_INTENT_REQUIRES_IMPLEMENTATION_HANDOFF"],
  IMPLEMENTATION: ["DENY", "CONTROLLER", "PRODUCT_OWNER_CANNOT_IMPLEMENT"],
  ...
  MODEL_OVERRIDE: ["DENY", "SPAWNER", "CALLER_MODEL_OVERRIDE_FORBIDDEN"],
  SELF_REVIEW: ["DENY", "INDEPENDENT_EVALUATOR", "PRODUCT_OWNER_SELF_REVIEW_FORBIDDEN"],
  CROSS_PROJECT_CONTEXT: ["DENY", "SPAWNER", "CROSS_PROJECT_CONTEXT_FORBIDDEN"],
...
export function evaluateProductOwnerBoundary(input, sideEffectBoundary = null) {
  ...
  else if (input.model_context_status !== "CURRENT") decision = ["DENY", "SPAWNER", "CURRENT_MODEL_CONTEXT_REQUIRED"];
