...
export function compileBoundaryContract({ownerBoundaries = undefined, projectLifeContract, deliveryPolicy, technicalBaseline = null, discovery = []} = {}) {
  ...
  const ownerSovereign = [
    ownerRecord({boundary_id: "OWNER_PRODUCT_INTENT", subject: "north_star_and_first_useful_workflow", authority: "CURRENT_OWNER_INTENT", automatic_allowed: ["IMPLEMENT_WITHIN_THE_BOUND_NORTH_STAR_AND_FIRST_USEFUL_WORKFLOW"], forbidden: ["REDEFINE_THE_OWNER_OUTCOME_OR_SUCCESS_CONDITION"], on_limit: "ASK_ONLY_FOR_THE_ROUTE_CHANGING_INTENT", unaffected_work: "ADMITTED_WORKFLOW_IMPLEMENTATION", clear_condition: "NORTH_STAR_AND_FIRST_USEFUL_WORKFLOW_ARE_EXPLICIT", source_refs: ["project.north_star", "project.first_workflow"], owner_input: ownerInput}),
