...
export function resolveAiSearchRagCanonicalAuthority() {
  ...
  assert(handoff.changed_paths.includes("control/ai-search-rag-boundary-gate.mjs") && handoff.changed_paths.includes("control/ai-search-rag-authority-binding.mjs") && handoff.changed_paths.includes("control/ai-search-rag-package-evaluator.mjs") && handoff.changed_paths.includes("tests/verify-ai-search-rag-boundary.mjs") && handoff.changed_paths.includes("schemas/ai-search-rag-gate-execution.v1.json"), "AI Search/RAG handoff omits executable package paths", "AI_SEARCH_RAG_HANDOFF_INVALID");
