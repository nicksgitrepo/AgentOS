...
export function compileStorageDailyInspection({
  ...
  previousCleanupCycle = null, previous_cleanup_cycle,
} = {}) {
  ...
  if (previous_cleanup_cycle !== undefined || previousCleanupCycle !== null) validateStorageRegenerationCycle(previous_cleanup_cycle ?? previousCleanupCycle);
