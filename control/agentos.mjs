...
export {compileObservedDispatchSuccessorBinding, compileObservedDispatchSourceSuccessor, validateObservedDispatchSuccessorBinding, OBSERVED_DISPATCH_BINDING_SCHEMA, OBSERVED_DISPATCH_BINDING_VERSION, OBSERVED_DISPATCH_BINDING_REQUIRED_STATUS, OBSERVED_DISPATCH_BINDING_PROVEN_STATUS} from "./observed-dispatch-binding-gate.mjs";
