...
export const DEVELOPMENT_PHASES = Object.freeze({
  RAPID_PROTOTYPING: Object.freeze([
    ...
    Object.freeze({id: "ITERATION_HANDOFF", name: "Keep improving in fresh campaigns", owner: "AGENTOS.ORCHESTRATOR", result: "A typed next step bound to the accepted result or open finding."}),
  ]),
  ITERATION: Object.freeze([
    ...
    Object.freeze({id: "INDEPENDENT_AUDIT", name: "Check the result separately", owner: "INDEPENDENT_AUDITOR", result: "A truthful pass, repair finding, or clear stop."}),
    Object.freeze({id: "CAMPAIGN_CLOSURE", name: "Close or repair and continue", owner: "AGENTOS.ORCHESTRATOR", result: "Preserved handoff, closed temporary workers, and the next safe campaign."}),
  ]),
});
...
export function compileDevelopmentPlan({mode = DEFAULT_DEVELOPMENT_MODE, northStar, firstWorkflow, protectedBoundaries, firstCampaign} = {}) {
  ...
  const plan = {
    ...
    persistent_roles: ["AGENTOS.SPAWNER", "AGENTOS_CONTROLLER", "AGENTOS.PRODUCT_OWNER", "AGENTOS.MEMORY", "AGENTOS.RUNTIME", "AGENTOS.SCHEDULER", "AGENTOS.ORCHESTRATOR"],
...
export function validateDevelopmentPlan(plan, {northStar = null, firstWorkflow = null, protectedBoundaries = null, firstCampaign = null} = {}) {
  ...
  assert(JSON.stringify(plan.persistent_roles) === JSON.stringify(["AGENTOS.SPAWNER", "AGENTOS_CONTROLLER", "AGENTOS.PRODUCT_OWNER", "AGENTOS.MEMORY", "AGENTOS.RUNTIME", "AGENTOS.SCHEDULER", "AGENTOS.ORCHESTRATOR"]), "persistent development roles are invalid");
