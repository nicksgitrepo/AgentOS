...
function validate(input) {
  ...
  exact(e.adversarial_flags, new Set(FLAGS), "Deadlock adversarial flags"); Object.values(e.adversarial_flags).forEach((value) => assert(typeof value === "boolean", "adversarial flag must be boolean", "DEADLOCK_BOOLEAN_INVALID"));
