...
const atomicSpecs = [
  {slug: "rust-backend", blockId: "specialist.software-language-runtime.rust-backend", genericIds: ["ENG.RUST_BACKEND"], title: "Rust Backend Language Semantics", purpose: "Analyze Rust language and backend runtime constraints for the exact locked reference, without owning architecture, storage, or deployment decisions.", upstream: "specialist.software-language-runtime.router", signals: ["ENG.RUST_BACKEND", "rust", "rust backend"], sources: [sourceCatalog.atomicLaw, sourceCatalog.rust], context: ["language.edition", "runtime.toolchain", "candidate.identity"], knowledge: ["Rust Reference 1.97.1", "edition and toolchain identity", "ownership, borrowing, and unsafe boundary evidence"], included: ["Rust language semantics", "edition/toolchain compatibility", "language-level backend findings"], nonGoals: ["architecture selection", "database design", "deployment", "Product acceptance"]},
  {slug: "typescript-language", blockId: "specialist.software-language-runtime.typescript-language", genericIds: ["ENG.TYPESCRIPT_REACT_WEB"], title: "TypeScript Language and Compiler Semantics", purpose: "Analyze TypeScript language and compiler-version behavior for the exact locked release, without absorbing React or browser UX authority.", upstream: "specialist.software-language-runtime.router", signals: ["typescript", "TypeScript compiler", "ENG.TYPESCRIPT_REACT_WEB"], sources: [sourceCatalog.atomicLaw, sourceCatalog.typescript], context: ["language.version", "compiler.options", "candidate.identity"], knowledge: ["TypeScript 5.9 release notes", "compiler configuration", "type-system and emitted-code evidence"], included: ["TypeScript version behavior", "compiler option implications", "typed language findings"], nonGoals: ["React component behavior", "CSS or browser UX", "deployment", "Product acceptance"]},
  {slug: "react-components", blockId: "specialist.software-language-runtime.react-components", genericIds: ["ENG.TYPESCRIPT_REACT_WEB"], title: "React Component Runtime", purpose: "Analyze React 19.2 component and runtime behavior for the exact locked version, without substituting for TypeScript, accessibility, or product design specialists.", upstream: "specialist.software-language-runtime.router", signals: ["react", "React component", "ENG.TYPESCRIPT_REACT_WEB"], sources: [sourceCatalog.atomicLaw, sourceCatalog.react], context: ["framework.version", "component.boundary", "candidate.identity"], knowledge: ["React 19.2 release behavior", "component and hook boundaries", "runtime evidence"], included: ["React component runtime", "framework-version compatibility", "component-level findings"], nonGoals: ["TypeScript compiler semantics", "accessibility conformance", "UX acceptance", "deployment"]},
  {slug: "postgresql-rls", blockId: "specialist.data.postgresql-rls", genericIds: ["DATA.POSTGRES_RLS"], title: "PostgreSQL Row-Level Security", purpose: "Analyze PostgreSQL row-security policy semantics and tenant-boundary evidence for the exact locked documentation version.", upstream: "specialist.data.router", signals: ["DATA.POSTGRES_RLS", "postgresql RLS", "row-level security", "tenant isolation"], sources: [sourceCatalog.atomicLaw, sourceCatalog.postgres], context: ["database.engine", "database.version", "data.tenant-boundary", "candidate.identity"], knowledge: ["PostgreSQL 17 row-security policies", "policy enablement and enforcement", "tenant-boundary evidence"], included: ["row-level security policy behavior", "tenant boundary evidence", "policy test obligations"], nonGoals: ["general schema design", "migration execution", "backup/restore", "legal privacy conclusions"]},
  {slug: "openapi-contracts", blockId: "specialist.product-client.openapi-contracts", genericIds: ["ARCH.API_CONTRACTS"], title: "OpenAPI HTTP Contract", purpose: "Analyze OpenAPI 3.1.1 contract identity and requirement-level consistency without writing Product behavior or selecting an API implementation.", upstream: "specialist.product-client.router", signals: ["ARCH.API_CONTRACTS", "openapi", "API contract", "HTTP schema"], sources: [sourceCatalog.atomicLaw, sourceCatalog.openapi], context: ["api.contract", "api.version", "candidate.identity"], knowledge: ["OpenAPI Specification 3.1.1", "operation and schema identity", "contract evidence and compatibility"], included: ["OpenAPI 3.1.1 contract semantics", "operation/schema traceability", "versioned contract findings"], nonGoals: ["backend implementation", "product acceptance", "deployment", "legal or regulatory certification"]},
  {slug: "oauth-identity", blockId: "specialist.security.oauth-identity", genericIds: ["SEC.AUTH_IDENTITY"], title: "OAuth Security Identity Flow", purpose: "Analyze OAuth security flow risks against RFC 9700 for the exact declared authorization context.", upstream: "specialist.security.router", signals: ["SEC.AUTH_IDENTITY", "oauth", "OAuth security", "authorization flow"], sources: [sourceCatalog.atomicLaw, sourceCatalog.oauth], context: ["identity.protocol", "identity.flow", "identity.client-type", "candidate.identity"], knowledge: ["RFC 9700 OAuth security BCP", "flow and client constraints", "threat and mitigation evidence"], included: ["OAuth flow security", "client/authorization-server evidence", "version-bound mitigation obligations"], nonGoals: ["OIDC claims semantics", "provider account administration", "credential handling", "legal advice"]},
  {slug: "oidc-core", blockId: "specialist.security.oidc-core", genericIds: ["SEC.AUTH_IDENTITY"], title: "OpenID Connect Core Claims", purpose: "Analyze OpenID Connect Core 1.0 authentication and claims contracts without absorbing OAuth security, account authority, or user acceptance.", upstream: "specialist.security.router", signals: ["openid connect", "OIDC", "identity claims"], sources: [sourceCatalog.atomicLaw, sourceCatalog.oidc], context: ["identity.protocol", "identity.claims", "identity.issuer", "candidate.identity"], knowledge: ["OpenID Connect Core 1.0", "issuer and claims semantics", "authentication evidence"], included: ["OIDC Core claims", "issuer and flow contract", "version-bound authentication findings"], nonGoals: ["OAuth threat model", "provider account changes", "credential handling", "product acceptance"]},
  {slug: "aws-iam-policy", blockId: "specialist.platform.aws-iam-policy", genericIds: ["PLATFORM.AWS_CLOUDFLARE_EDGE", "CLOUD.AWS_IAM"], title: "AWS IAM Policy Elements", purpose: "Analyze AWS IAM policy element semantics for the exact provider documentation snapshot without granting account or deployment authority.", upstream: "specialist.platform.provider-edge-router", signals: ["aws iam", "AWS policy", "CLOUD.AWS_IAM"], sources: [sourceCatalog.atomicLaw, sourceCatalog.awsIam], context: ["provider.name", "provider.region", "iam.policy", "candidate.identity"], knowledge: ["AWS IAM policy elements", "action/resource/condition semantics", "provider version and account evidence"], included: ["IAM policy element semantics", "policy evidence", "least-privilege findings"], nonGoals: ["AWS account mutation", "secrets or credentials", "network/storage/deployment controls", "provider certification"]},
  {slug: "cloudflare-dns", blockId: "specialist.platform.cloudflare-dns", genericIds: ["PLATFORM.AWS_CLOUDFLARE_EDGE", "EDGE.CLOUDFLARE_DNS"], title: "Cloudflare DNS Records", purpose: "Analyze Cloudflare DNS record semantics for the exact documentation snapshot without changing zones or asserting account authority.", upstream: "specialist.platform.provider-edge-router", signals: ["cloudflare dns", "EDGE.CLOUDFLARE_DNS", "DNS records"], sources: [sourceCatalog.atomicLaw, sourceCatalog.cloudflareDns], context: ["provider.name", "dns.zone", "dns.records", "candidate.identity"], knowledge: ["Cloudflare DNS record management", "record type and zone evidence", "external account/zone custody"], included: ["DNS record semantics", "zone-scoped evidence", "configuration findings"], nonGoals: ["zone mutation", "TLS/WAF/cache policy", "credentials", "deployment"]},
  {slug: "cloudflare-cache", blockId: "specialist.platform.cloudflare-cache", genericIds: ["PLATFORM.AWS_CLOUDFLARE_EDGE", "EDGE.CLOUDFLARE_CACHE"], title: "Cloudflare Cache Rules", purpose: "Analyze Cloudflare cache-rule matching and behavior for the exact documentation snapshot without purging, deploying, or changing edge state.", upstream: "specialist.platform.provider-edge-router", signals: ["cloudflare cache", "EDGE.CLOUDFLARE_CACHE", "cache rules"], sources: [sourceCatalog.atomicLaw, sourceCatalog.cloudflareCache], context: ["provider.name", "cache.rule", "cache.scope", "candidate.identity"], knowledge: ["Cloudflare Cache Rules", "matching and cache behavior", "edge scope and purge boundary"], included: ["cache-rule semantics", "rule matching evidence", "edge behavior findings"], nonGoals: ["cache purge", "DNS/TLS/WAF", "deployment", "provider account mutation"]},
];

function buildBlock(spec) {
  const isRouter = spec.roleKind === "ROUTER";
  const dependencies = sorted([...(isRouter ? ["specialist.foundation.role-intake-classifier", "specialist.foundation.scope-non-goal-gate"] : foundationDependencies), ...(spec.upstream ? [spec.upstream] : [])]);
