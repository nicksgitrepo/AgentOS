...
function validate(input) {
  ...
  exact(input.evidence, new Set([
    ...
    "upstream_router_result_sha256", "context_receipt_sha256", "memory_readback_sha256", "fixture_contract_sha256", "project_data_present", "secret_data_present", "adversarial_flags",
  ...
  for (const key of ["candidate_digest", "source_manifest_sha256", "standard_block_sha256", "standard_source_manifest_sha256", "model_snapshot_sha256", "model_route_sha256", "upstream_router_result_sha256", "context_receipt_sha256", "memory_readback_sha256", "fixture_contract_sha256"]) digest(e[key], `evidence.${key}`);
