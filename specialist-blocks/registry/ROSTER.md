...
role and not a deployer. Its corrected candidate has a fresh independent
qualification, but remains candidate-only and inactive (`CANDIDATE` / `OFF`)
until the sealed Spawner consumes its canonical admission and seed receipts.
...
candidate readback; activation, admission, and spawning remain sealed
Spawner actions.
...
position after those permanent roles, with its corrected model route and
independent readback current. All other entries remain queued or
...
| `specialist.security.function-scope` | `ATOMIC_SPECIALIST`; `specialist.security.access-control-router` | `specialist.standard.owasp-asvs` | `1.0.0`; independent PASS receipt `c4f464be…`; `specialist-eval.function-scope.v1` | 12 executable gates; 17 hostile vectors; qualified for sealed Spawner reuse; activation remains `OFF` |
...
| `specialist.security.double-submission` | `ATOMIC_SPECIALIST`; `specialist.security.access-control-router` | `specialist.standard.owasp-asvs` | `1.0.0`; independent PASS receipt `7e7278bf…`; `specialist-eval.double-submission.v1` | 12 executable gates; 17 hostile vectors; qualified for sealed Spawner reuse; activation remains `OFF` |
