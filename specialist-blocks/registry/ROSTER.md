...
| `CLIENT.IOS_SWIFTUI` | `specialist.product-client.ios-swiftui` / `ATOMIC_SPECIALIST` | [Apple SwiftUI](https://developer.apple.com/documentation/swiftui/); upstream product/client router | `1.0.0`; independent PASS receipt `332b60fb…`; `specialist-eval.ios-swiftui.v1` | 12 executable gates; 17 hostile vectors; qualified for sealed Spawner reuse; activation remains `OFF` |
