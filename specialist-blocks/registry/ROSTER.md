...
| `specialist.security.concurrent-authorization` | `ATOMIC_SPECIALIST`; `specialist.security.access-control-router` | `specialist.standard.owasp-asvs` | `1.0.0`; `INDEPENDENT_PASS_READBACK` (`d75a40b6…`); `specialist-eval.concurrent-authorization.v1` | 12 executable gates; 17 hostile vectors; `ACCEPTED_QUALIFIED / OFF`; sealed Spawner reuse only |
...
| `specialist.security.cve-applicability` | `ATOMIC_SPECIALIST`; `specialist.security.supply-chain-router` | `specialist.standard.nist-ssdf`, `specialist.standard.slsa` | `1.0.0`; `INDEPENDENT_PASS_READBACK` (`36e258e5…`); `specialist-eval.cve-applicability.v1` | 12 executable gates; 17 hostile vectors; `ACCEPTED_QUALIFIED / OFF`; sealed Spawner reuse only |
