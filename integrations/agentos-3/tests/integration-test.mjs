...
assert.equal(first.descriptor.interfaces.continuity, "AVAILABLE_GUARDED_TEST_ONLY");
assert.equal(first.descriptor.interfaces.handoff_journal, "AVAILABLE_GUARDED_TEST_ONLY");
assert.equal(first.descriptor.interfaces.successor_transfer, "AVAILABLE_GUARDED_TEST_ONLY");
