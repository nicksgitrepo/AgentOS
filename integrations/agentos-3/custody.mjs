...
export async function verifyBundle(bundlePathInput) {
  ...
  if (JSON.stringify(Object.keys(bundle).sort()) !== JSON.stringify(["build_id", "entries", "schema"]) || JSON.stringify(Object.keys(manifest).sort()) !== JSON.stringify(["activation", "build_id", "bundle_sha256", "entries", "lifecycle", "rollback_identity", "schema", "source_base"])) throw new Error("BUNDLE_SCHEMA_INVALID");
