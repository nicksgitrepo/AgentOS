...
export async function verifyBundle(bundlePathInput) {
  ...
  if (JSON.stringify(manifest.includes) !== JSON.stringify(["current-main-core", "memory-m2", "agent-builder", "specialist-library-intake-seam", "root-schemas"])) throw new Error("BUNDLE_COMPONENT_SET_INVALID");
